...
namespace ZetaHtmlEditControl.UI
{
    ...
    public partial class HtmlEditUserControl : UserControl
    {
        ...
        private void updateButtons()
        {
            ...
            //自定义的功能按钮
            this.btnPrint.Visible = this.htmlEditControl.Configuration.AllowPrint;
        ...
        {
            htmlEditControl.InsertPicture();
        }

        private void btnInsertEmbedImage_Click(object sender, EventArgs e)
        {
