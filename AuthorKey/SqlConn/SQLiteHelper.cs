...
namespace AuthorKey.SqlConn
{
    public static class SQLiteHelper
    {
        public static string ReadConnectionStrings()
        {
            ...
            string connectionString = ConfigurationManager.ConnectionStrings["sqlite"].ConnectionString.ToString();
        ...
        /// 执行数据库操作(新增、更新或删除)
        /// </summary>
        /// <param name="SqlCommText">Sql更新语句 无参数</param>
        /// <returns></returns>
        public static int ExecuteNonQuery(string SqlCommText)
        {
            int result = 0;
            SQLiteCommand SqlCom = new SQLiteCommand();
            SqlCom.CommandText = SqlCommText;
            result = ExecuteNonQuery(SQLiteHelper.ReadConnectionStrings(), SqlCom);
            return result;
        }
        /// <summary>
        /// 执行数据库操作(新增、更新或删除)
        ...
        /// </summary>
        /// <param name="SqlCommand">Sql更新语句 无参数</param>
        /// <returns>空行返回null</returns>
        public static DataTable ExecuteDataTable(string SqlCommand)
        {
            ...
            Ds = SQLiteHelper.ExecuteDataSet(SQLiteHelper.ReadConnectionStrings(), SqlCom);
        ...
        /// <param name="cmd">SqlCommand对象</param>
        /// <returns></returns>
        public static DataTable ExecuteDataTable(string connectionString, SQLiteCommand cmd)
        {
            DataTable Dt = new DataTable();
            System.Data.DataSet Ds = new System.Data.DataSet();
